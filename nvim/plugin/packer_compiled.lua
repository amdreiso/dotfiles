...
_G.packer_plugins = {
  ...
  ["fzf-lua"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/fzf-lua",
  ...
  ["mini.pairs"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/mini.pairs",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/presence.nvim",
    url = "https://github.com/andweeb/presence.nvim"
  },
  ["vim-css-color"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/vim-css-color",
